...
st.markdown('<style>' + open('./style/style_navbar.css').read() + '</style>', unsafe_allow_html=True)

with st.sidebar:
    tabs = on_hover_tabs(tabName=["Home", "Data", "About"], iconName=['dashboard', 'money', 'economy'],default_choice=0)
